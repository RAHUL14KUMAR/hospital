...
function Layout() {
  ...
  return (
    <div className="p-1">
        {/* navbar */}
        <div className="h-14 flex w-100 bg-emerald-100 justify-between p-2 fixed top-0 left-0 right-0">
        ...
        <div className="flex mt-12">
            <div className='md:w-1/4 relative'>
                <div className="hidden md:block w-1/5 bg-emerald-100 h-screen rounded-sm flex-col  justify-between items-center mt-2 fixed top-13 left-0">
            ...
            {/* body for children */}
            {!toggle && 
                <div className="mt-2 bg-emerald-100 w-full ml-1 p-2">
                    {setComponent()}
                </div>
            }
        </div>
